...
CREATE TABLE `tblcar` (
  ...
  KEY `fk_tblCar_brand_idx` (`brand`),
  CONSTRAINT `fk_tblCar_brand` FOREIGN KEY (`brand`) REFERENCES `tblcarbrand` (`id`),
...
INSERT INTO `tblcar` VALUES (1,'KIA Morning',1000,'Free','kia','30B14004',1,1,1,1),(2,'KIA Rio',1200,'Free','kia','30B14005',1,1,1,1),(3,'KIA Soul',2000,'Free','kia','30B14006',1,1,1,1),(4,'KIA Sedona',1500,'Free','Kia','30b14007',1,1,1,1),(5,'Ferrari 812',5000,'Free','','30B14008',1,1,3,1),(6,'Ferrarri SF90',5000,'Free',NULL,'30B14009',1,1,3,1),(7,'Mercedes GLC300',4000,'Free',NULL,'30B14010',1,1,2,1);
...
DROP TABLE IF EXISTS `tblcarbrand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `tblcarbrand` WRITE;
/*!40000 ALTER TABLE `tblcarbrand` DISABLE KEYS */;
INSERT INTO `tblcarbrand` VALUES (1,'KIA',NULL),(2,'Mercedes',NULL),(3,'Ferrari',NULL);
/*!40000 ALTER TABLE `tblcarbrand` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tblcartype` VALUES (1,'Sedan','sedan'),(2,'HatchBack','hatchback'),(3,'SUV','SUV'),(4,'Sport','sport'),(5,'Minivan','minivan');
...
-- Dump completed on 2020-06-25 18:50:12
