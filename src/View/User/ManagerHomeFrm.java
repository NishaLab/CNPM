...
public class ManagerHomeFrm extends javax.swing.JFrame implements ActionListener{
     ...
     */
    private JButton btnStore, btnCar, btnStat;
    private Staff s;
    
    public ManagerHomeFrm(Staff s) {
        super("Manager home");	
        this.s = s;
        
	btnStore = new JButton("Store management");
        btnCar = new JButton("Car management");
    ...
    private void initComponents() {
        ...
        jButton1.setText("Store management");

        jButton2.setText("Car Management");

        jButton3.setText("View statistc");
